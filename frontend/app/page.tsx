...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen pt-[72px] relative overflow-hidden">
      ...
      <div className="absolute -top-24 -left-36 w-[600px] h-[600px] rounded-full pointer-events-none bg-[radial-gradient(circle,rgba(56,189,248,0.08)_0%,transparent_70%)]" />
      <div className="absolute top-48 -right-24 w-[500px] h-[500px] rounded-full pointer-events-none bg-[radial-gradient(circle,rgba(99,102,241,0.06)_0%,transparent_70%)]" />
      <div className="absolute bottom-48 left-[30%] w-[400px] h-[400px] rounded-full pointer-events-none bg-[radial-gradient(circle,rgba(14,165,233,0.05)_0%,transparent_70%)]" />
